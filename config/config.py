...
# 指定gdb文件夹路径
FILE_ROOT = r'C:/xxxxx/xxxxx/xxxxx/xxxxx/路网优化/测试过程数据库/'
# 指定新建gdb名称
DATABASE_NAME = 'ROAD_OPTIMIZE.gdb'
# 指定目标城市基础数据路径,文件夹内数据命名格式如下
# 路网数据: 1.osm_xiangcheng.shp 2. qq_xiangcheng.shp
# 边界数据: xiangcheng.shp
ROAD_DATA = r'C:/xxxxx/xxxxx/xxxxx/xxxxx/路网优化/测试路网数据/'
BOUNDARY_DATA = r'/xxxxx/xxxxx/xxxxx/xxxxx/路网优化/测试边界数据/'
OUTPUT_PATH = r'/xxxxx/xxxxx/xxxxx/xxxxx/路网优化/测试输出数据'
######################################配置区结束#################################
